const BLOG = {
  ...
  GREETING_WORDS:
    ...
    'Hi,👏 搜源盘,一站式构建个性化资源网站，围绕网盘网站,商品分佣灯商业模式打造你的搜索引擎APP,欢迎来到我的博客🎉',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Moonlite', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '搜源盘同款系统搭建网盘资源网站🧰', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://docs.moonlite.top', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion,搜源盘,网盘,资源', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'sogasvip@gmail.com', // 邮箱地址 例如mail@tangly1024.com
  CONTACT_WEIBO: process.env.NEXT_PUBLIC_CONTACT_WEIBO || '', // 你的微博个人主页
  CONTACT_TWITTER: process.env.NEXT_PUBLIC_CONTACT_TWITTER || '', // 你的twitter个人主页
  CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || 'https://github.com/starrsiy/NotionNext', // 你的github个人主页 例如 https://github.com/tangly1024
  ...
  COMMENT_WALINE_SERVER_URL: process.env.NEXT_PUBLIC_WALINE_SERVER_URL || 'https://vsage.zeabur.app', // 请配置完整的Waline评论地址 例如 hhttps://preview-waline.tangly1024.com @see https://waline.js.org/guide/get-started.html
  ...
  SEO_GOOGLE_SITE_VERIFICATION:
    process.env.NEXT_PUBLIC_SEO_GOOGLE_SITE_VERIFICATION || 'meta name="google-adsense-account" content="ca-pub-1884573821030917"', // Remove the value or replace it with your own google site verification code
